...
static const Vtx coin_seg3_vertex_red[] = {
    {{{   -36,      0,      0}, 0, {   -16,   4080}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    36,      0,      0}, 0, {  4080,   4080}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    36,     72,      0}, 0, {  4080,    -16}, {0x90, 0x00, 0xff, 0xff}}},
    {{{   -36,     72,      0}, 0, {   -16,    -16}, {0x90, 0x00, 0xff, 0xff}}},
};
...
// 0x03005740
static const Vtx coin_seg3_vertex_red[] = {
    {{{   -35,      0,      0}, 0, {     0,   4032}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    35,      0,      0}, 0, {  4032,   4032}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    35,     70,      0}, 0, {  4032,      0}, {0x90, 0x00, 0xff, 0xff}}},
    {{{   -35,     70,      0}, 0, {     0,      0}, {0x90, 0x00, 0xff, 0xff}}},
};
#else
static const Vtx coin_seg3_vertex_yellow[] = {
...
// 0x03005740
static const Vtx coin_seg3_vertex_red[] = {
    {{{   -35,      0,      0}, 0, {     0,   1984}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    35,      0,      0}, 0, {  1984,   1984}, {0x90, 0x00, 0xff, 0xff}}},
    {{{    35,     70,      0}, 0, {  1984,      0}, {0x90, 0x00, 0xff, 0xff}}},
    {{{   -35,     70,      0}, 0, {     0,      0}, {0x90, 0x00, 0xff, 0xff}}},
};
#endif
