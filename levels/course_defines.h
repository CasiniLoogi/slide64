...
DEFINE_COURSE(COURSE_BOB, 0x00044440) // (1)  Bob Omb Battlefield
DEFINE_COURSE(COURSE_SSL, 0x44444440) // (2)  Shifting Sand Land
DEFINE_COURSE(COURSE_LLL, 0x44444440) // (3)  Lethal Lava Land
DEFINE_COURSE(COURSE_WF, 0x00220040) // (4)  Whomp's Fortress
DEFINE_COURSE(COURSE_JRB, 0x22222240) // (5)  Jolly Rodger's Bay
DEFINE_COURSE(COURSE_CCM, 0x22222240) // (6)  Cool Cool Mountain
DEFINE_COURSE(COURSE_BBH, 0x44444440) // (7)  Big Boo's Haunt
DEFINE_COURSE(COURSE_HMC, 0x44444440) // (8)  Hazy Maze Cave
