...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		OBJECT(MODEL_NONE, -42, 5274, -1317, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -42, 5274, -1317),
		OBJECT(MODEL_NONE, -106, 4583, -159, 0, 0, 0, 0x00010000, bhvWarp),
	...
	AREA(2, lll_area_2),
		...
		OBJECT(MODEL_SPINDEL_LAVA, -3325, -6389, -5777, 0, 0, 0, 0x00000000, bhvSpindelLava),
		...
		OBJECT(MODEL_STAR, -4025, -5694, -7470, 0, 0, 0, 0x00000000, bhvStar),
