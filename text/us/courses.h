COURSE_ACTS(COURSE_BOB, _(" 1 SLIDE HIGH IN THE SKY"),
       _("PLEASANT SLIDE HIGH IN THE SKY")     , _("HURRY UP, SLIDE HIGH IN THE SKY") , _("PURPLE COINS HIGH IN THE SKY"),
       _("FIND THE 8 RED COINS")          , _("MARIO WINGS TO THE SKY")        , _("BEHIND CHAIN CHOMP'S GATE"))

COURSE_ACTS(COURSE_SSL, _(" 2 GNARLY SANDY SHELL SHREDDIN'"),
       _("SANDY SURFIN' IN THE HOT SUN") , _("SPEEDY SHELLIN' ON BITCHIN' DUNES")      , _("MULLERIN' PURPLE COINS"),
       _("STAND TALL ON THE FOUR PILLARS"), _("FREE FLYING FOR 8 RED COINS")   , _("PYRAMID PUZZLE"))

COURSE_ACTS(COURSE_LLL, _(" 3 HOT LAVA CAVING"),
       _("CRIPPLING CAVING IN THE HOT VOLCANO")            , _("DASHING DELVING IN THE HOT VOLCANO")             , _("PARCHED PURPLE COIN COLLECTING"),
       _("RED-HOT LOG ROLLING")           , _("HOT-FOOT-IT INTO THE VOLCANO")  , _("ELEVATOR TOUR IN THE VOLCANO"))

COURSE_ACTS(COURSE_WF, _(" 4 WHOMP'S FORTRESS"),
...
COURSE_ACTS(COURSE_JRB, _(" 5 JOLLY ROGER BAY"),
...
COURSE_ACTS(COURSE_CCM, _(" 6 COOL, COOL MOUNTAIN"),
...
COURSE_ACTS(COURSE_BBH, _(" 7 BIG BOO'S HAUNT"),
...
COURSE_ACTS(COURSE_HMC, _(" 8 HAZY MAZE CAVE"),
...
CASTLE_SECRET_STARS(_("   YOU HAVE"))
